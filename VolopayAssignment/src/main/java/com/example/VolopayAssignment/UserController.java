...
package com.example.VolopayAssignment;
...
public class UserController {
    ...
    @Autowired
    com.example.Volopayassignment.UserService userService;

    //adding data into database
    @PostMapping("/add-data")
    public String addData(@RequestBody com.example.volopayAssigment.User user)
    {
